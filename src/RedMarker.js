...
import pinRed from './img/pinRed.png'
import pinGreen from './img/pinGreen.png'
import pinRedHover from './img/pinRed-hover.png'
...
export default class RedMarker extends React.Component {
  static propTypes = {
  ...
  image () {
    return this.props.status==='WARNING' ? (this.isHover() ? pinRedHover : pinRed) : (this.isHover() ? pinGreenHover : pinGreen)
  }
  ...
  componentDidMount () {
    let images = [
      pinRed, pinGreen, pinRedHover,pinGreenHover
    ]
